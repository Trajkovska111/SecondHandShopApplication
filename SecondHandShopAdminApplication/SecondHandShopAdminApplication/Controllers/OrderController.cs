...
namespace SecondHandShopAdminApplication.Controllers
{
    public class OrderController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            string URI = "https://localhost:44350/api/Admin/GetOrders";
        ...
        public IActionResult Details(Guid id)
        {
            ...
            string URI = "https://localhost:44350/api/Admin/GetDetailsForProduct";
        ...
        public FileContentResult CreateInvoice(Guid id)
        {
            ...
            foreach (var item in result.ProductInOrders)
            {
                ...
                sb.AppendLine(item.OrderedProduct.ProductName + " with quantity of: " + item.Quantity + " and price of: " + item.OrderedProduct.Price + "$");
            }
